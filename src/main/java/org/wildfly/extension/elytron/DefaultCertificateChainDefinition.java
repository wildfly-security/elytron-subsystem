...
/**
 * A {@link ResourceDefinition} for basic {@link Certificate} representations.
 *
 * @author <a href="mailto:darran.lofthouse@jboss.com">Darran Lofthouse</a>
 */
class DefaultCertificateChainDefinition extends SimpleResourceDefinition {

    DefaultCertificateChainDefinition() {
        super(PathElement.pathElement(ElytronDescriptionConstants.CERTIFICATE_CHAIN, ElytronDescriptionConstants.DEFAULT),
            ElytronExtension.getResourceDescriptionResolver(ElytronDescriptionConstants.KEYSTORE, ElytronDescriptionConstants.ALIAS,
                    ElytronDescriptionConstants.CERTIFICATE_CHAIN, ElytronDescriptionConstants.DEFAULT));
    }
